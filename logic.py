...
# LOGIC ERROR. With n=6, this produces 1, 1, 2, 3, 5, 8, 13, 21.
# The logic error results from the stop value in range.
# Because the original list already contains this first two terms in the sequence, the final length is two terms too many.
